...
//1: mailAddress	//2: Assignor	//3: Assignor's Department
function getAssignor(value) {
    var mailAddress = value[1];
    var assignorName = value[2];
    var pjNameOfAssignor = value[3];
    var assignor = "【Assignor】" + assignorName + "（"  + pjNameOfAssignor + "）\n";
    assignor += "【TO】<mailto:" + mailAddress + "|" + mailAddress + ">" + "\n";
    return assignor;
}
